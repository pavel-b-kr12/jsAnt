...
var colorAdds=[0.02, -0.1];


var op_per_frame=10000;
var iiAdd_each_op=100; //e.g. for increment color by time left
var ii=0;
var ii_counter=0;
...
for (var i = 0; i < op_per_frame; i++,ii_counter++) { //100000000
	if(ii_counter==iiAdd_each_op)
	{
		...
		osc.frequency.value=80+(ant.dir)*256; //%4   Math.sin(ant.dir)*256;
	}
